...
import './DeviceNamePhys.css';

interface DeviceNamePhysProps {
  setDeviceName: (deviceName: string) => void;
  setSelectedPhys: (selectedPhys: string) => void;
}

const DeviceNamePhys: React.FC<DeviceNamePhysProps> = ({ setDeviceName, setSelectedPhys }) => {
